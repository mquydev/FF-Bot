...
async def GeTSQDaTa(D):
    uid = D['5']['data']['1']['data']
    chat_code = D["5"]["data"]["31"]["data"]
    squad_code = D["5"]["data"]["33"]["data"]
...
"""async def GeTSQDaTa(D):
    try:
        p5 = D['5']['data']
        uid        = p5['1']['data']
        chat_code  = p5['31']['data']   # confirmed ✅
        squad_code = p5['33']['data']   # confirmed = QR secret ✅
        return uid, chat_code, squad_code
    except KeyError as e:
        print(f"GeTSQDaTa missing field: {e}")
